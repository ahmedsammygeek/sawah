                    ...
                    <tr>
                        ...
                        <td class='row g-2 align-items-center' >
                            <div class='col-6 col-sm-4 col-md-2 col-xl-auto '>
                                <a href="{{ route('board.goals.show' , $goal) }}" class="btn btn-primary w-100 btn-icon" aria-label="Facebook">
                            ...
                            <div class='col-6 col-sm-4 col-md-2 col-xl-auto '>
                                <a href="{{ route('board.goals.edit' , $goal ) }}" class="btn btn-warning w-100 btn-icon" aria-label="Facebook">
                            ...
                            <div class='col-6 col-sm-4 col-md-2 col-xl-auto '>
                                <a class="btn btn-danger w-100 btn-icon" wire:click="$emit('confirmDeletion' , {{ $goal->id }} )" aria-label="Facebook">
