...
<div class="page-body">
	<div class="container-xl">
		<div class="row row-deck row-cards">
			<div class="col-md-12">
				<form class="card" method='POST' action='{{ route('board.goals.store') }}' enctype="multipart/form-data" >
					@csrf
					<div class="card-header bg-primary">
						<h3 class="card-title text-white"> إضافه هدف جديد </h3>
					</div>
					<div class="card-body">
						...
						<div class="mb-3">
							...
							<div>
								<textarea  class="form-control @error('content') is-invalid @enderror " name='content'  cols="30" rows="10"> {{ old('content') }} </textarea>
								@error('content')
								<small class="form-hint text-danger"> {{ $message }} </small>
								@enderror
							</div>
