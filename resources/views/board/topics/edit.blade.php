...
<div class="page-body">
	<div class="container-xl">
		<div class="row row-deck row-cards">
			<div class="col-md-12">
				<form class="card" method='POST' action='{{ route('board.topics.update' , $topic) }}' enctype="multipart/form-data" >
					@csrf
					@method('PATCH')
					<div class="card-header bg-primary">
						<h3 class="card-title text-white"> تعديل بيانات المقال </h3>
					</div>
					<div class="card-body">
						...
						<div class="mb-3">
							...
							<div>
								<label class="form-check">
									<input class="form-check-input" name='is_active' type="checkbox" {{ $topic->is_active == 1 ? 'checked' : '' }}>
					...
					<div class="card-footer text-end">
						<div class='d-flex' >
							<a href="{{ route('board.topics.index') }}" class="btn btn-link"> تراجع </a>
