...
<div class="page-body">
	<div class="container-xl">
		<div class="row row-deck row-cards">
			<div class="col-md-12">
				<form class="card" method='POST' action='{{ route('board.services.update' , $service) }}' >
					@csrf
					@method('PATCH')
					...
					<div class="card-body">
						...
						<div class="mb-3">
							...
							<div>
								<input type="text" class="form-control @error('name_en') is-invalid @enderror " name='name_en' value="{{ $service->getTranslation('name' , 'en') }}" >
								@error('name_en')
								<small class="form-hint text-danger"> {{ $message }} </small>
								@enderror
							</div>
						...
						<div class="mb-3">
							...
							<div>
								<input type="text" class="form-control @error('subtitle_ar') is-invalid @enderror " name='subtitle_ar' value="{{ $service->getTranslation('subtitle' , 'ar') }}" >
								@error('subtitle_ar')
								<small class="form-hint text-danger"> {{ $message }} </small>
								@enderror
							</div>
						...
						<div class="mb-3">
							...
							<div>
								<input type="text" class="form-control @error('subtitle_en') is-invalid @enderror " name='subtitle_en' value="{{ $service->getTranslation('subtitle' , 'en') }}" >
								@error('subtitle_en')
								<small class="form-hint text-danger"> {{ $message }} </small>
								@enderror
							</div>
						...
						<div class="mb-3">
							...
							<div>
								<textarea  class="form-control @error('content_ar') is-invalid @enderror " name='content_ar' id="tinymce-mytextarea" cols="30" rows="10"> {{ $service->getTranslation('content'  , 'ar' ) }} </textarea>
								@error('content_ar')
								<small class="form-hint text-danger"> {{ $message }} </small>
								@enderror
							</div>
						...
						<div class="mb-3">
							...
							<div>
								<textarea  class="form-control @error('content_en') is-invalid @enderror " name='content_en' id="tinymce-mytextarea" cols="30" rows="10"> {{ $service->getTranslation('content'  , 'en' ) }} </textarea>
								@error('content_en')
								<small class="form-hint text-danger"> {{ $message }} </small>
								@enderror
							</div>
						...
						<div class="mb-3">
							...
							<div>
								<label class="form-check">
									<input class="form-check-input" name='active' type="checkbox" {{ $service->is_active == 1 ? 'checked' : '' }}>
